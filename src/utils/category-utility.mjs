import { CATEGORY_ENCODING_LENGTH } from './../config/constants.mjs';
...
const categoryEncodings = {};

/** Loop categories array retrieved manually from YT Data API
 * and assign binary encodings to each category.
 */
categories.forEach((element) => {
    categoryEncodings[element.id] = {
        encoding: encodeToBinarySequence(parseInt(element.id), CATEGORY_ENCODING_LENGTH),
        title: element.snippet.title
    }
});

/** Returns the encoding of a category.
 * @param {string} categoryId - The ID of the category to retrieve the encoding for.
 * @returns {Array} The binary encoding of the category.
 */
export const getCategoryEncoding = (categoryId) => {
    return categoryEncodings[categoryId].encoding;
}